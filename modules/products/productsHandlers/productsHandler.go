...
const (
	...
	insertProductErr  productsHandlersCodeErr = "products-003"
	deleteProductErr  productsHandlersCodeErr = "products-004"
	updateProductErr  productsHandlersCodeErr = "products-005"
)
