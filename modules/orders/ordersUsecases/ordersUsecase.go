...
import (
	...
	"github.com/k0msak007/kawaii-shop/modules/orders"
...
func OrderUsecase(ordersRepository ordersRepositories.IOrdersRepository, productsRepository productsRepositories.IProductRepository) IOrdersUsecase {
